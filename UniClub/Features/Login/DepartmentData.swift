...
struct DepartmentData {
    static let colleges: [College] = [
        ...
        College(name: "정보기술대학", departments: ["컴퓨터공학부", "정보통신공학과", "임베디드시스템공학과"]),
        College(name: "경영대학", departments: ["경영학부", "회계세무학과", "재무부동산학과", "융합기술경영학과"]),
        ...
        College(name: "생명과학기술대학", departments: ["생명과학부", "생명공학부", "생체분자과학부"]),
